...
##################################
PROJECT_NAME: str = "SUIM"
PROJECT_NAME_FULL: str = "SUIM: Semantic Segmentation of Underwater Imagery"
...
RELEASE_DATE: Optional[str] = "2020-04-03"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://irvlab.cs.umn.edu/resources/suim-dataset"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 6570154
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/suim"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = ["https://drive.google.com/drive/folders/10KMK0rNB43V2g30NcA1RYipL535DuZ-h?usp=sharing"]
